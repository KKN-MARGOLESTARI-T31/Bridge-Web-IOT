-- seed_correct.sql - Seeding dengan schema yang benar
-- Jalankan SETELAH menjalankan fix_schema.sql

-- ==============================================
-- 1. SEED PH READINGS (20 data)
-- ==============================================

-- Generate CUID-like IDs (simplified version using timestamp + random)
...
-- Latest pH readings
SELECT id, value, location, timestamp, "deviceId" 
FROM ph_readings 
ORDER BY timestamp DESC 
LIMIT 5;

-- Latest water level readings
SELECT id, level, location, timestamp, status 
